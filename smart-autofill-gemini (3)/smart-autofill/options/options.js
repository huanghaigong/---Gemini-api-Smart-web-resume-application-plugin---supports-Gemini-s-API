...
async function loadAll() {
  ...
  $("fallbackModels").value = s.fallbackModels || DEFAULTS.fallbackModels;
...
async function ensurePermission(baseUrl) {
  ...
  if (/\.generativelanguage\.googleapis\.com$/.test(new URL(baseUrl).hostname) || new URL(baseUrl).hostname === "generativelanguage.googleapis.com") {
